...
class RhythmGeneratorApp : public App
{
public:
  RhythmGeneratorApp();
  virtual ~RhythmGeneratorApp();

  // lifetime and game-loop events
  void setup() override;
...
CINDER_APP( RhythmGeneratorApp, RendererGl )
